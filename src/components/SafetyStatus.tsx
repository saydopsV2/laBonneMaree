    ...
    return (
        <div className="md:col-span-4 bg-surface-container-lowest rounded-xl p-6 shadow-sm border border-outline-variant/10">
            <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                    <h4 className="font-headline font-bold text-primary">Status: Safe</h4>
                    <p className="text-xs text-on-surface-variant">Under-keel clearance: 2.1m</p>
                </div>
            </div>
            <div className="space-y-3">
                <div className="flex justify-between items-center text-sm p-3 bg-surface rounded-lg">
                    <span className="text-on-surface-variant">Current Draft</span>
