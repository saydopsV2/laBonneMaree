    ...
    return (
        <div className="md:col-span-8 bg-surface-container-lowest rounded-xl overflow-hidden shadow-sm border border-outline-variant/10 flex flex-col md:flex-row">
            <div className="md:w-1/2 p-6">
                <span className="font-label text-xs font-bold uppercase tracking-widest text-outline mb-4 block">Active Port</span>
                <h3 className="font-headline text-2xl font-extrabold text-primary mb-2">Port of Brest, France</h3>
                <p className="text-sm text-on-surface-variant mb-6">Pier 7 / Southern Harbor Entrance</p>
                <div className="grid grid-cols-2 gap-4">
                    <div className="flex flex-col gap-1">
                        <span className="text-[10px] font-bold text-outline uppercase">Wind</span>
                        <span className="font-bold text-primary">12 knots NW</span>
                    </div>
                    <div className="flex flex-col gap-1">
                        <span className="text-[10px] font-bold text-outline uppercase">Visibility</span>
