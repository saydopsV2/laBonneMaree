        ...
        <div>
            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-sm font-medium text-on-surface-variant mt-1">Hauteur de marée actuelle</p>
                </div>
            ...
            <div className="space-y-6">
                <div className="h-32 w-full bg-surface-container-highest rounded-lg relative overflow-hidden">
                    ...
                    <div className="absolute bottom-[35%] left-0 w-full h-[2px] bg-secondary flex items-center px-2">
                        <span className="bg-secondary text-white text-[10px] px-1.5 py-0.5 rounded font-bold -mt-6 whitespace-nowrap">TIRANT: 2.1m</span>
                    </div>
                </div>
